                                    ...
                                    <hr>
										...
										<tr>
                                            ...
                                            <th class="m-0 font-weight-bold text-dark">
                                                <select class="input_U" name="id_user" id="id_user" onchange="ValidateIDUser();" value="<?php echo $id_user ; ?>">
                                                    <?php
                                                        include_once '../controller/UtilisateurC.php';
                                                        $utilisateurC = new UtilisateurC();
                                                        $utilisateurs = $utilisateurC->afficher_Utilisateur();
                                                        foreach($utilisateurs as $user) {
                                                    ?>
                                                    <option <?=$id_user==$user['id_user']?'selected="selected"':'';?> value="<?php echo $user['id_user'];?>"><?php echo $user['id_user'] ." - " .$user['nom_user'] ." " .$user['prenom_user'];?></option>
                                                    <?php } ?>
                                                </select>
                                            </th>
