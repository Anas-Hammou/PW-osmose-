...
}else 
{
    ...
    if (isset($_POST['ID_Commande'] )   && isset($_POST['ID_OFFRE'] )   ) 
    {
...
<table border="1" align="center">
                <tr>
                    ...
                    <td><input type="number" name="ID_Commande" id="ID_Commande" maxlength="20" value="<?php echo $a['ID_Commande'];?>"  readonly></td>
                </tr>
				<tr>
                    <td>
                    ...
                    <td><input type="number"  name="ID_OFFRE" id="ID_OFFRE"   maxlength="20"  value="<?php echo $a['ID_OFFRE'];?>" ></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="number"  name="ID_CLIENT" id="ID_CLIENT" maxlength="20" value="<?php echo $a['ID_CLIENT'];?>"></td>
                </tr>         
                <tr>
                    <td>
