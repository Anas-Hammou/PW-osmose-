                    ...
                    if (
                        ...
                        if (
                            ...
                            $message = 'Bonjour ' .$nom_user.' '.$prenom_user .',
                                        ...
                                        <br> 
                                        <a href = "http://localhost/osmose/BackViews/confirmation_compte.php?username='.urlencode($username).'&confirmation_key='.$confirmation_key.'">Activez votre compte ici</a>
                                        <br><br>
                                        Cordialement.';
