    ...
    if (isset($_SESSION["username"]))
    {
        ...
        else
        {
            ...
            $message = 'Bonjour ' .$nom_user.' '.$prenom_user .',
                        ...
                        <br> 
                        <a href = "http://localhost/Integration_Gestion_Utilisateurs/FrontViews/confirmation_compte.php?username='.urlencode($username).'&confirmation_key='.$confirmation_key.'">Réactivez votre compte ici</a>
                        <br><br>
                        Cordialement.';
