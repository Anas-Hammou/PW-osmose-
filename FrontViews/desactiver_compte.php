    ...
    if (isset($_SESSION["username"]))
    {
        ...
        else
        {
            ...
            $message = 'Bonjour ' .$nom_user.' '.$prenom_user .',
                        ...
                        <br> 
                        <a href = "http://localhost/osmose/FrontViews/confirmation_compte.php?username='.urlencode($username).'&confirmation_key='.$confirmation_key.'">Réactivez votre compte ici</a>
                        <br><br>
                        Cordialement.';
