...
if (isset($_SESSION["username"]))
{
    ...
    else if ($_SESSION["role_user"] == "Adminitrateur")
            ...
            if (isset($_REQUEST['signup']))
            {
                    ...
                    ($UsernameUser_error == 0)))
                {
                    ...
                    if ($MDPUser_error == 1){
                        ...
                        $error = $error ."Mot de passe (minimum 8 caractères) "; 
                    }      
                }else{
                    $error = "";
                        ...
                        if (
                            ...
                            if ($password_user == $verifpassword_user)
                            {
                                ...
                                $message = 'Bonjour ' .$nom_user.' '.$prenom_user .',
                                            ...
                                            <br> 
                                            <a href = "http://localhost/Integration_Gestion_Utilisateurs/FrontViews/confirmation_compte.php?username='.urlencode($username).'&confirmation_key='.$confirmation_key.'">Activez votre compte ici</a>
                                            <br><br>
                                            Cordialement.';
                                ...
                                echo '<script type="text/javascript">window.alert("Votre compte a été crée avec succès. Vérifiez vos mails pour l\'activer");</script>';
                                sleep(5);
