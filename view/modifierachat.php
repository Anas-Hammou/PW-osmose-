...
{
    echo $_POST['ID_ACHAT'] ;
        $achat = new achat($_POST['ID_ACHAT'] , $_POST['TITRE'] ,$_POST['PRIX'],$_POST['ID_COMMANDE']);
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages"
                    ...
                    <span>Pages achat</span>
                </a>
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">page</h6>
                        <a class="collapse-item" href="achat.html">achat</a>
                        <a class="collapse-item" href="categorie.html">categorie</a>
...
<form action="" method="POST">
            <table border="1" align="center">
                ...
                <tr>
                    ...
                    <td><input type="number" name="ID_COMMANDE" id="ID_COMMANDE" maxlength="20" value="<?php echo $a['ID_COMMANDE'];?>"  ></td>
                </tr>
