...
<form action="" method="POST">
            <table border="1" align="center">
                ...
                <tr>
                    ...
                    <td><input type="text" name="description" id="description" " value="<?php echo $a['description'];?>"  ></td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td><input type="number" name="idcategorie" id="idcategorie" maxlength="20" value="<?php echo $a['idcategorie'];?>"  ></td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="auteur" id="auteur" maxlength="20" value="<?php echo $a['auteur'];?>"  ></td>
                </tr>
				<tr>
                    <td>
                        <label for="date">date:
