...
$sql1 = "SELECT COUNT(*) AS cntreply FROM like_unlike WHERE replyid=".$replyid." and id=".$id;
...
if($count1 == 0){
    $insertquery1 = "INSERT INTO like_unlike(id,replyid,type) values(".$replyid.",".$id.",".$type.")";
    $con1->exec($insertquery1);
    //$query = $con->prepare($insertquery);
    //$query->exec();
  //  mysqli_query($con,$insertquery);
}else {
    $updatequery1 = "UPDATE like_unlike SET type=" . $type . " where id=" . $id . " and replyid=" . $replyid;
