<?PHP
	...
	class Utilisateur{
		...
		private $confirmation_key = null ;
		private $confirme = null ;

		function __construct(string $nom_user, string $prenom_user, String $email_user, int $tel_user, string $adresse_user, 
			string $username, string $password_user, string $role_user, string $confirmation_key, int $confirme)
		{
		...
		function getConfirmationKey(): string{
			return $this->confirmation_key;
		}
		function getConfirme(): int{
		...
		function setConfirmationKey(string $confirmation_key): void{
			$this->confirmation_key = $confirmation_key;
		}   
		function setConfirme(int $confirme): void{
			$this->confirme = $confirme;
		}   
	}
?>