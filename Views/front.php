...
{
        $formation = new reclamation($_POST['idrec'] , $_POST['texte']);
        $formationC= new reclamationC();
...
<body>
    <nav>
        ...
        <a href="#home"  onclick=window.location.href='article.html'>Home</a>
            ...
            <div class="dropdown">
            <a class="dropbtn"onclick=window.location.href='front.php'>formations</a>
...
<?php foreach($formationS as $formation): ?>
    <div class="card">
      ...
      <h4 class="formateur">par :<?php echo $formation['formateur'];?></h4>
